## atlantean_sys7_ipr
SYS7 is an ERP framework 100% owned by Atlantean Technical Solutions Limited
...
- z.php atrium page
- PHP lib classes (Model, View, Controller, Crudtroller, Session etc)
- JS client libs
- "out of the box" modules (People, Places, Things, Operations)
